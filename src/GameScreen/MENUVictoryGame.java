...
public class MENUVictoryGame {
   private JFrame frame  = Window.frame;
    ...
    private JLabel victoryGameLabel = new JLabel(new ImageIcon(getClass().getResource("/images/label/VICTORY.png")));
    ...
    public MENUVictoryGame(Game g){
        ...
        victoryGameLabel.setBounds(640-400/2, 100, 400, 500);
        victoryGameLabel.setVisible(false);
        frame.getContentPane().add(victoryGameLabel);
    }
    public void showVictoryGame(){
        ...
        victoryGameLabel.setVisible(true);
        ShowHighScore.setVisible(true);
        ShowLastScore.setVisible(true);
    }
    private void dontShowVictoryGame(){
        Game.endGame = false;
        playButton.setVisible(false);
        QuitButton.setVisible(false);
        victoryGameLabel.setVisible(false);
