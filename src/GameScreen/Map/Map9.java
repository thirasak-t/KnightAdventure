...
public class Map9 extends Map{
    ...
    protected void createXObstacle() {
        for(int i = 0; i<6;i++){
            xObstacle[0][i] = new LFireball(552-64*0);
            xObstacle[1][i] = new RSoulball(552-64*1);
            xObstacle[2][i] = new LFireball(552-64*2);
            xObstacle[3][i] = new RMagicball(552-64*3);
            xObstacle[4][i] = new LSoulball(552-64*4);
            xObstacle[5][i] = new RSoulball(552-64*5);
            xObstacle[6][i] = new LMagicball(552-64*6);
